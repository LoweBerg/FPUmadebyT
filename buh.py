...
wn.setup(width=600,
         height=600)  # Screen Border lenght - Changeble but WARNING! You need to re-code some in "Main Game Loop" and Snake Border Setup
...
while True:
    ...
    if head.xcor() > 290 or head.xcor() < -290 or head.ycor() > 290 or head.ycor() < -290:
        ...
        pen.clear()
        pen.write("Puan: {}  En Yüksek Puan: {}".format(score, high_score), align="center",
